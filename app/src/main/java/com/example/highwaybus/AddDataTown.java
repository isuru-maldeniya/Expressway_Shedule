...
public class AddDataTown {
    FirebaseDatabase database ;
    DatabaseReference myRef ;
    LinkedList<AddTown> towns;

    public AddDataTown() {
        database = FirebaseDatabase.getInstance();
        myRef = database.getReference("Kandy");
        towns=new LinkedList<>();
    }
    public void setList(){

//        towns.add(new AddTown("Kandy"));
//        towns.add(new AddTown("Kadawatha"));
//        towns.add(new AddTown("Nanwinna(Maharagama)"));
//        towns.add(new AddTown("Panadura"));
//        towns.add(new AddTown("Horana"));
//        towns.add(new AddTown("Ingiriya"));
//        towns.add(new AddTown("Kaluthara"));
        towns.add(new AddTown("Matara"));
//        towns.add(new AddTown("Mathugama"));
